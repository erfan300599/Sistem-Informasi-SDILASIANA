    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2><?php echo $data_cek1['judul_kegiatan']; ?></h2>
          <ol>
            <li><a href="index.php">Beranda</a></li>
    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            <img src="<?php echo 'dashboard/admin/gambar/kegiatan/' . $data_cek1['gambar_kegiatan']; ?>" alt="">
          </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Tanggal Kegiatan</strong>: <?php echo tglIndonesia2(date('d F Y', strtotime($data_cek1['tanggal_postingan']))); ?></li>
                <li><strong>User Posting</strong>: <?php echo $data_cek1['user_postingan']; ?></li>
              </ul>
            </div>
