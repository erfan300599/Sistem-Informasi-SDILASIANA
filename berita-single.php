    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2><?php echo $data_cek1['judul_berita']; ?></h2>
          <ol>
            <li><a href="index.php">Beranda</a></li>
            <li><a href="berita.php">Berita Sekolah</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="entry-img">
                <img src="<?php echo 'dashboard/admin/gambar/berita/' . $data_cek1['gambar_berita']; ?>" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="berita-single.php?kode=<?php echo $data['id_berita']; ?>"><?php echo $data_cek1['judul_berita']; ?></a>
              </h2>

              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="berita-single.php?kode=<?php echo $data['id_berita']; ?>"><?php echo $data_cek1['user_postingan']; ?></a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="berita-single.php?kode=<?php echo $data['id_berita']; ?>"><time datetime="2020-01-01"><?php echo tglIndonesia2(date('d F Y', strtotime($data_cek1['tanggal_postingan']))); ?></time></a></li>
                </ul>
              </div>
