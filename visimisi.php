...
<head>
  ...
  <meta content="width=device-width, initial-scale=1.0" name="viewport">
   ...
   <title>VISI & MISI - <?php echo $data_cek['nama_sekolah']?></title>
    ...
    <section id="clients" class="clients">
      <div class="container">
        ...
        <div data-aos="fade-up">
          <h3 data-aos="fade-up">VISI <span style="color: #fd5c28;">SEKOLAH</span></h3>
        </div>
        <div data-aos="fade-up">
        ...
        <br>
          <div data-aos="fade-up">
          <h3 data-aos="fade-up">MISI <span style="color: #fd5c28;">SEKOLAH</span></h3>
        </div>
        <div data-aos="fade-up">
            <p><?php echo $data_cek['misi_sekolah']?></p>
        </div>
      </div>
