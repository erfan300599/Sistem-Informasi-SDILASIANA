	...
	<div class="login-box">
		...
		<div class="card">
			<div class="card-body login-card-body">
				<center>
					<h1>
						<b class="text-primary">REGISTRASI</b>
					</h1>
					<br>
				</center>
...
if (isset($_POST['btnsave'])) {  
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO tb_pengguna (nama_pengguna,alamat,telepon,username,password,level) VALUES (
            '".$_POST['nama_pengguna']."',
          '".$_POST['alamat']."',
        '".$_POST['telepon']."',
      '".$_POST['username']."',
 ...
 'Pasien')";
	   ...
	   if ($query_simpan) {
		...
		echo "<script>
			Swal.fire({title: 'Akun Anda Gagal Terdaftar',text: '',icon: 'error',confirmButtonText: 'OK'
			}).then((result) => {if (result.value)
				{window.location = 'login.php';}
			})</script>";
		}
